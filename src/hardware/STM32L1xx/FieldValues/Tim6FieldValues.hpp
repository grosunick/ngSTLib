...
struct TIM6_CR2_MMS_Values : public RegisterField<Reg, offset, size, AccessMode> {
     ...
     */
    using ComparePulse = FieldValue<TIM6_CR2_MMS_Values, 3U, BaseType>;
    // 100: Compare - OC1REF signal is used as trigger output (TRGO)
    using CompareOC1REF = FieldValue<TIM6_CR2_MMS_Values, 4U, BaseType>;
    // 101: Compare - OC2REF signal is used as trigger output (TRGO)
    using CompareOC2REF = FieldValue<TIM6_CR2_MMS_Values, 5U, BaseType>;
    // 110: Compare - OC3REF signal is used as trigger output (TRGO)
    using CompareOC3REF = FieldValue<TIM6_CR2_MMS_Values, 6U, BaseType>;
    // CompareOC4REF signal is used as trigger output (TRGO)
    using CompareOC4REF = FieldValue<TIM6_CR2_MMS_Values, 7U, BaseType>;
};
