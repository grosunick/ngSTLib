...
{
  using Enabled = FieldValue<TIM6_CR1_ARPE_Values, 0U, BaseType>;
  using Disabled = FieldValue<TIM6_CR1_ARPE_Values, 1U, BaseType>;
};
...
{
  using Value0 = FieldValue<TIM6_CR1_URS_Values, 0U, BaseType>;
  using Value1 = FieldValue<TIM6_CR1_URS_Values, 1U, BaseType>;
};
...
{
  using Value0 = FieldValue<TIM6_DIER_UDE_Values, 0U, BaseType>;
  using Value1 = FieldValue<TIM6_DIER_UDE_Values, 1U, BaseType>;
};

template <typename Reg, size_t offset, size_t size, typename AccessMode, typename BaseType> 
struct TIM6_DIER_UIE_Values: public RegisterField<Reg, offset, size, AccessMode> 
{
  using Value0 = FieldValue<TIM6_DIER_UIE_Values, 0U, BaseType>;
  using Value1 = FieldValue<TIM6_DIER_UIE_Values, 1U, BaseType>;
};

template <typename Reg, size_t offset, size_t size, typename AccessMode, typename BaseType> 
struct TIM6_SR_UIF_Values: public RegisterField<Reg, offset, size, AccessMode> 
{
  using IsCleared = FieldValue<TIM6_SR_UIF_Values, 0U, BaseType>;
...
{
  using Value0 = FieldValue<TIM6_EGR_UG_Values, 0U, BaseType>;
  using Value1 = FieldValue<TIM6_EGR_UG_Values, 1U, BaseType>;
};
